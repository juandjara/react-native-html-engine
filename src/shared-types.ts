 ...
 *
 * ```ts
 * declare module 'react-native-html-engine' {
...
export interface TRenderEngineConfig {
   ...
   * @example
   * ```tsx
   * import RenderHTML, {defaultSystemFonts} from 'react-native-html-engine'
...
export interface RenderHTMLConfig
   ...
   * import RenderHTML, { CustomBlockRenderer } from 'react-native-html-engine';
